...
function SlideOne() {
  return (
    <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full max-w-sm mx-auto">
      ...
      {/* Phone body */}
      <motion.rect
        x="130" y="40" width="140" height="240" rx="24"
      ...
      {/* Lock shield floating top right */}
      <motion.g animate={{ y: [-6, 6, -6] }} transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }}>
        ...
        <path d="M302 78 C302 73 318 73 318 78 L318 87 C318 89 316 91 310 91 C304 91 302 89 302 87 Z"
      ...
      {/* Connection dots */}
      {[
        { x: 90, y: 120 }, { x: 320, y: 150 }, { x: 80, y: 200 }, { x: 330, y: 220 }
      ].map((dot, i) => (
        <motion.circle key={i} cx={dot.x} cy={dot.y} r="4"
      ...
      {/* Connecting lines */}
      <motion.line x1="90" y1="120" x2="130" y2="140" stroke="rgba(37,99,235,0.3)" strokeWidth="1" strokeDasharray="4 4"
        animate={{ opacity: [0.2, 0.6, 0.2] }} transition={{ duration: 2, repeat: Infinity }} />
      <motion.line x1="270" y1="150" x2="320" y2="150" stroke="rgba(37,99,235,0.3)" strokeWidth="1" strokeDasharray="4 4"
      ...
      >
        ...
        <div style={{
          ...
          >
            ...
            <p style={{ color: 'rgba(148,163,184,0.8)', fontSize: '14px', margin: '0 0 32px' }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              >
                ...
                <input
                  ...
                  style={inputStyle}
                  onFocus={e => { e.target.style.border = '1px solid rgba(37,99,235,0.8)'; e.target.style.boxShadow = '0 0 0 3px rgba(37,99,235,0.15)'; e.target.style.background = 'rgba(255,255,255,0.07)'; }}
